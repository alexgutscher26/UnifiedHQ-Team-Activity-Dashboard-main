...
class BranchManager {
   ...
   * `.github` directory. It checks for the file's existence and attempts to read and parse its contents.
   * In case of a parsing error, a warning is logged, and the function falls back to the default configuration.
   * If the file does not exist, it directly returns the default configuration.
   */
  loadConfig () {
