...
function TestComponent() {
  ...
  return <div>Test</div>;
            ...
            const leak: LeakDetectionResult = {
                ...
                codeSnippet: "element.addEventListener('scroll', handleScroll, { passive: true })"
            };
...
function TestComponent() {
  ...
  return <div>Test</div>;
            ...
            assert.strictEqual(result.success, true);
            assert.ok(result.fix);
            assert.ok(result.fix.fixedCode.includes('mediaQuery.removeEventListener'));
...
function TestComponent() {
  ...
  return <div>Test</div>;
            ...
            const leak: LeakDetectionResult = {
                ...
                codeSnippet: "document.addEventListener('click', () => console.log('clicked'))"
            };
...
function TestComponent() {
  ...
  return <div>Test</div>;
            ...
            const leak: LeakDetectionResult = {
                ...
                codeSnippet: "element.addEventListener('click', function(e) { e.preventDefault(); })"
            };
...
const TestComponent = () => {
  ...
  return <div>Test Component</div>;
            ...
            const leak: LeakDetectionResult = {
                ...
                line: 4,
                column: 3,
                description: 'Event listener in arrow function component without cleanup',
                codeSnippet: "document.addEventListener('click', handleClick)"
            };
...
function TestComponent() {
  ...
  return <div>Test</div>;
            ...
            assert.strictEqual(result.success, false);
            assert.ok(result.error);
            assert.ok(result.error.includes('Could not analyze event listener pattern'));
        });
