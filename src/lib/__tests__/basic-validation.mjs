...
try {
    ...
    console.log(`  ✅ Pattern detection works: addEventListener found = ${hasEventListener}`);
    console.log(`  ✅ Cleanup detection works: removeEventListener found = ${hasCleanup}`);
    ...
    console.log(`  ✅ Leak type validation: ${testLeak.type} is supported = ${isSupported}`);
