...
export function createSafeLogger(prefix: string) {
  ...
  return {
    log: (...args: unknown[]) =>
      safeLogger.log(`[${sanitizedPrefix}]`, ...args),
    error: (...args: unknown[]) =>
      safeLogger.error(`[${sanitizedPrefix}]`, ...args),
    warn: (...args: unknown[]) =>
      safeLogger.warn(`[${sanitizedPrefix}]`, ...args),
    info: (...args: unknown[]) =>
      safeLogger.info(`[${sanitizedPrefix}]`, ...args),
    debug: (...args: unknown[]) =>
      safeLogger.debug(`[${sanitizedPrefix}]`, ...args),
  };
}
