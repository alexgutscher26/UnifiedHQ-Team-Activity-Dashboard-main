...
/**
 * Optimized AI Summary Card Component with useCallback for performance
 *
 * This component has been optimized to prevent unnecessary re-renders by:
 * - Using useCallback for event handlers
 * - Memoizing callback functions that don't depend on changing values
 * - Avoiding inline arrow functions in JSX props
 */
