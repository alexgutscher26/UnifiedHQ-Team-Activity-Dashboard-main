...
const NavigationTrackerContext = createContext<NavigationTrackerContextType | null>(null)
...
export function useNavigationTrackerContext() {
    ...
    if (!context) {
        throw new Error('useNavigationTrackerContext must be used within NavigationTrackerProvider')
    }
